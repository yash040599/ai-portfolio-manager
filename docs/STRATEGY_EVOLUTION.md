...
| 253 | Risk | Session-wide pause armed at startup when the trailing 3 trading days are net ≤ −Rs.300 AND profit-factor < 0.6 AND ≥ 5 trades. No new entries that session; existing positions managed normally. Origin: 2026-04-22 → 2026-05-05 8-day losing streak that no intra-day circuit breaker (#163 daily soft-stop, #168 peak drawdown, #244 loss-streak) caught — each individual day's loss was below the soft-stop trigger but the cumulative drift was unambiguous. The intra-day breakers protect the day; this one protects against a bad week. Thresholds tuned same-day from a backtest sweep — the originally-shipped PF<0.5 AND net<−Rs.500 only armed once over the trailing 16 sessions; the live thresholds (PF<0.6 AND net<−Rs.300) would have armed 6 times over the same window, all net-negative, saving Rs.+387 cumulative. |
