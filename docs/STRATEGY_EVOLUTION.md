...
| 253 | Risk | Session-wide pause armed at startup when the trailing 3 trading days are net negative AND profit-factor < 0.5 AND ≥ 5 trades. No new entries that session; existing positions managed normally. Origin: 2026-04-22 → 2026-05-05 8-day losing streak that no intra-day circuit breaker (#163 daily soft-stop, #168 peak drawdown, #244 loss-streak) caught — each individual day's loss was below the soft-stop trigger but the cumulative drift was unambiguous. The intra-day breakers protect the day; this one protects against a bad week. |
