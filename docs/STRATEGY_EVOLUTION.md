...
> Last regenerated: 2026-05-07. Items: 164 strategy rows (#1 → #258). Bug-fix rows are intentionally excluded; see `STRATEGY_ROADMAP.md` for the full Bug Fix log.
