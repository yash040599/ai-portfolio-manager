...
|---|----------|--------------|
| T3.3 | Performance | Phase 9 diversification research (2026-06-12): tested 4 alternative intraday strategies — all FAIL. FHRB (PF 0.81), OCM (PF 0.87), NIFTY Index Momentum (PF 0.25), Sector Rotation (PF 0.78). Also confirmed NIFTY100 optimal (NIFTY150 PF 1.13, NIFTY200 PF 1.17 — both worse). Gap-and-Go v1.1.1 remains the only strategy to pass the 1.15 OOS gate. Intraday equity search space on NSE largely exhausted. |
