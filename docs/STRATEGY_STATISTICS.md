...
| Rolling-PF circuit breaker #253 (multi-day cold-streak, 2026-05-05) | Risk mgmt | +0.20 | −20 % | Session-wide pause when trailing 3d PF < 0.6 AND net ≤ −Rs.300 AND n ≥ 5. Trigger: 04-22 → 05-05 8/8 losing days, FY-PF crossed 1.0; existing intra-day breakers (#163/#168/#244) all fired correctly each day yet still let cumulative drift through. Thresholds tuned same-day from a backtest sweep — the originally-shipped PF<0.5 AND net<−Rs.500 only armed once over the trailing 16 sessions; the live thresholds armed 6 times, all net-negative, saving Rs.+387 cumulative (8× the original variant). Conservative failure mode (over-pause) |
