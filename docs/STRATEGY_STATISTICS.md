...
| Rolling-PF circuit breaker #253 (multi-day cold-streak, 2026-05-05) | Risk mgmt | +0.20 | −20 % | Session-wide pause when trailing 3d PF < 0.5 AND net ≤ −Rs.500 AND n ≥ 5. Trigger: 04-22 → 05-05 8/8 losing days, FY-PF crossed 1.0; existing intra-day breakers (#163/#168/#244) all fired correctly each day yet still let cumulative drift through. Conservative failure mode (over-pause) |
