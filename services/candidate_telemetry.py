# ================================================================
# services/candidate_telemetry.py
# ================================================================
...
# pipeline (UNIQUE_TABLES in `scripts/backup_data.py`).
#
# Three writers (write-only API; readers go through scripts/view_*):
#   1. `record_scored(candidate)` — called by the V2 scanner for every
#      candidate that passes the V2_MIN_SCORE filter. Status = SCORED.
...
class CandidateTelemetry:
    ...
    def record_scored(self, candidate: dict, *, scan_time: str | None = None,
        ...
        try:
            ...
            # rather than silently mis-tag it as BUY. The V2_MIN_SCORE
