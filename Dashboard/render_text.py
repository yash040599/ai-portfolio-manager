...
from Dashboard.metrics import HeadlinePnL, net_pnl_pct
from Dashboard.verdict import VerdictResult
...
def _section_pending(dates: list[str], include_provisional: bool) -> str:
    ...
    body.append("    3. Run: python scripts/import_zerodha_taxpnl.py --fy <YYYY>")
    body.append("")
    return "\n".join(body)
