...
Usage
─────
    python scripts/trade/fill_intraday_ledger.py              # current FY
    python scripts/trade/fill_intraday_ledger.py --fy 2025    # FY 2025-26
    python scripts/trade/fill_intraday_ledger.py --all        # all FYs
    python scripts/trade/fill_intraday_ledger.py --list       # list FYs with live data
"""
