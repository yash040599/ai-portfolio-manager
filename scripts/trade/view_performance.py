...
Usage
─────
    python scripts/trade/view_performance.py              # all trades
    python scripts/trade/view_performance.py --days 7     # last 7 days
    python scripts/trade/view_performance.py --date 2026-04-08  # specific date
    python scripts/trade/view_performance.py --summary    # daily summary only (no trade details)
"""
