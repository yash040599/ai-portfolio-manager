...
Usage
─────
    python scripts/trade/view_intraday_ledger.py              # current FY
    python scripts/trade/view_intraday_ledger.py --fy 2025    # FY 2025-26
    python scripts/trade/view_intraday_ledger.py --list       # list FYs with data
"""
...
def list_fys():
    ...
    if not fys:
        ...
        print("  Run 'python scripts/trade/fill_intraday_ledger.py' first.")
        return
