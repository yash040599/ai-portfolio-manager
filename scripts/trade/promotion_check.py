...
Usage
-----
    python scripts/trade/promotion_check.py                 # last 20 sessions
    python scripts/trade/promotion_check.py --window 30
    python scripts/trade/promotion_check.py --min-trades 50
    python scripts/trade/promotion_check.py --json          # machine-readable
