...
`services/candidate_telemetry.py`. Use this to:
...
-----
    ...
    python scripts/view_candidates.py                 # today's rows
    python scripts/view_candidates.py --date 2026-05-12
    python scripts/view_candidates.py --since 2026-05-01
    python scripts/view_candidates.py --symbol RELIANCE
    python scripts/view_candidates.py --status REJECTED
    python scripts/view_candidates.py --summary       # cohort summary
    python scripts/view_candidates.py --hash          # group by config_hash
