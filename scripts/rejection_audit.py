...
Usage:
  python scripts/rejection_audit.py                # today
  python scripts/rejection_audit.py --date 2026-04-20
  python scripts/rejection_audit.py --append-report  # also append to trading_report_DD.txt
"""
