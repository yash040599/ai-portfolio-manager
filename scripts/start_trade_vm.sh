...
#
#   ./ai-portfolio-manager/scripts/start_trade_vm.sh                  # default: --noai --max 50000
#   ./ai-portfolio-manager/scripts/start_trade_vm.sh --max 30000      # custom args
#   ./ai-portfolio-manager/scripts/start_trade_vm.sh attach           # re-attach to live bot
#                                                                     #   (Ctrl-B then D to detach
#                                                                     #    without killing)
#   ./ai-portfolio-manager/scripts/start_trade_vm.sh status           # is the bot running?
#   ./ai-portfolio-manager/scripts/start_trade_vm.sh logs             # tail today's log file
#   ./ai-portfolio-manager/scripts/start_trade_vm.sh stop             # graceful Ctrl-C then kill
#
...
Then re-run: ./scripts/start_trade_vm.sh
EOF
  exit 1
fi
...
if ! yes y | python scripts/backup_data.py --ssh --all-remote; then
