...
Usage:
    python scripts/shared/generate_sheet.py                     # today's portfolio report
    python scripts/shared/generate_sheet.py 2026-03-16          # specific date
    python scripts/shared/generate_sheet.py --list              # list all available report dates
    python scripts/shared/generate_sheet.py --output out.tsv    # custom output path
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="Examples:\n"
               "  python scripts/shared/generate_sheet.py                  # today's report\n"
               "  python scripts/shared/generate_sheet.py 2026-03-16       # specific date\n"
               "  python scripts/shared/generate_sheet.py --list           # show available dates\n"
               "  python scripts/shared/generate_sheet.py 2026-03-16 -o ~/Desktop/sheet.tsv\n",
