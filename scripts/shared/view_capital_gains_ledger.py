...
Usage
─────
    python scripts/shared/view_capital_gains_ledger.py                     # current FY, all types
    python scripts/shared/view_capital_gains_ledger.py --fy 2025           # FY 2025-26
    python scripts/shared/view_capital_gains_ledger.py --type short_term   # short-term only
    python scripts/shared/view_capital_gains_ledger.py --type long_term    # long-term only
    python scripts/shared/view_capital_gains_ledger.py --list              # list FYs
"""
...
def list_fys():
    ...
    if not fys:
        ...
        print("  Run 'python scripts/shared/import_zerodha_taxpnl.py' first.")
        return
