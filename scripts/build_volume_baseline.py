"""
scripts/build_volume_baseline.py
================================================================
Build / refresh per-symbol intraday volume baselines (Roadmap #260).

Replaces the linear daily-volume pro-rating used by the V2 scanner's
...
-----
    ...
    python scripts/build_volume_baseline.py --lookback 30
    python scripts/build_volume_baseline.py --universe NIFTY100
    python scripts/build_volume_baseline.py --dry-run
...
`services/candle_cache.py` during normal trading. No network calls.
================================================================
"""
...
from services.volume_baseline import (  # noqa: E402
