...
scripts/backtest.py
================================================================
Offline replay harness for the V2 NoAI strategy (Roadmap #24).
...
script:
  ...
  3. If |score| ≥ V2_MIN_SCORE and time is in [10:00, 14:30] IST,
...
Usage
-----
    python scripts/backtest.py --from 2026-04-01 --to 2026-05-09
    python scripts/backtest.py --from 2026-04-01 --to 2026-05-09 \
...
def main():
    parser = argparse.ArgumentParser(
        description="Offline replay of V2 strategy on cached candles (#24)."
    )
    ...
    parser.add_argument("--min-score", type=int,
                        default=getattr(Config, "V2_MIN_SCORE", 5),
