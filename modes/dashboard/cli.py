...
from modes.dashboard.render_text import render as render_text
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not args.text and not args.no_open:
        from modes.dashboard.server import serve
    ...
    from modes.dashboard.render_html import build_payload, render_shell, write_and_maybe_open
